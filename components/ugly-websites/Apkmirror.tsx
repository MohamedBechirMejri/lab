  ...
  return (
    <div className="min-h-screen min-w-screen flex items-center">
      <div className="bg-[#f5f5f5] h-[85vh] w-[400px] relative rounded-xl shadow-2xl overflow-hidden border">
        <div className="bg-[#f76912] w-[90%] h-max absolute left-1/2 top-8 -translate-x-1/2 rounded-lg text-[#f5f5f5] font-semibold flex items-center gap-4 overflow-hidden p-2 shadow-xl">
          <Image
          ...
          <span className="w-8 h-full shrink-0 cursor-pointer flex justify-center items-center ">
